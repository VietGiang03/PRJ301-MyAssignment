 ...
 * @author sonng
 */
public class ListEmployeeController extends BaseRequiredLecturerAuthenticationController {
     ...
     */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, User user, Lecturer lecturer)
            throws ServletException, IOException {
        EmployeeDBContext db = new EmployeeDBContext();
        ArrayList<Employee> emps = db.list();
        request.setAttribute("emps", emps);
        request.getRequestDispatcher("../view/emp/list.jsp").forward(request, response);
