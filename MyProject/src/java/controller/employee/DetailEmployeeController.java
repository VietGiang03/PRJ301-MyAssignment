 ...
 * @author sonng
 */
public class DetailEmployeeController extends BaseRequiredLecturerAuthenticationController {
    ...
    throws ServletException, IOException {
       int id = Integer.parseInt(request.getParameter("id"));
        ...
        request.getRequestDispatcher("../view/emp/detail.jsp").forward(request, response);
    } 
